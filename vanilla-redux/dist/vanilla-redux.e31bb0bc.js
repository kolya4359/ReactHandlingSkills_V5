...
var btnDecrease = document.querySelector("#decrease"); // 액션 이름을 정의한다.

var TOGGLE_SWITCH = "TOGGLE_SWITCH";
var INCREASE = "INCREASE";
var DECREASE = "DECREASE"; // 액션 이름을 사용하여 액션 객체를 만드는 액션 생성 함수를 작성한다.
...
var store = (0, _redux.createStore)(reducer); // render 함수를 작성한다. 이 함수는 상태가 업데이트될 때마다 호출되며, 리액트의 render 함수와는 다르게
...
render(); // 스토어의 상태가 바뀔 때마다 render 함수가 호출되도록 구독한다.
